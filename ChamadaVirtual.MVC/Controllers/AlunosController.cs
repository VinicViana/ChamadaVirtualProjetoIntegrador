...
namespace ChamadaVirtual.MVC.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Matricula,TurmaId")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Matricula,TurmaId")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
